...
export default function FooterTwo() {
  return (
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 bg-[#b3201d] text-white dark:text-neutral-200 lg:text-left">
      ...
      <div className="px-6 py-10 text-center md:text-left bg-[#0c406e] text-white dark:bg-neutral-800 dark:text-neutral-200">
        <div className="grid-1 grid gap-10 md:grid-cols-3 lg:grid-cols-3">
          {/* <!-- TW Elements section --> */}
          <div className="">
            <Image
              width={150}
            ...
            />
            <p className="mt-4">
              MATH LLC specializes in BPO and back-office solutions, providing
              tailored, seamless services for CPA firms and small businesses.
            </p>
          </div>
          {/* <!-- Products section --> */}
          {/* <div className="">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              5900 Balcones Dr Ste 15916 Austin, TX 78731
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              1432 Sherman Street Apt Alameda, CA 94501
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
