...
export function MobileConvenience() {
  return (
    <section className="py-20 px-8">
      <div className="grid grid-cols-1 justify-center text-center lg:grid-cols-1 gap-12 max-w-6xl mx-auto items-center">
        {/* <Image
          width={256}
          height={256}
        ...
        <div className="col-span-1 mx-auto max-w-lg px-4 lg:px-0">
          <Typography variant="h2" color="blue-gray" className="mb-4 text-[#0c406e]">
